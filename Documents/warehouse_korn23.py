class WarehouseManage():
    ...
    def retrieve(self,_cmd):
        ...
        self.links(hx[0],'FWD')
        print("Retriving a product id "+_cmd+" in warehouse "+str(ord(hx[0])-ord('A'))+": "+"row "+str(hx[1])+" slot "+str(hx[2]))
        self.links(hx[0],'BKD')
    ...
    def store(self,_cmd):
        ...
        if(st==-1):
            ...
            if(st==-1):
                ...
                return -1
        self.links(hx[0],'FWD')
        print("Storing a product id "+_cmd+" in warehouse "+str(ord(hx[0])-ord('A'))+": "+"row "+str(hx[1])+" slot "+str(hx[2]))
        self.links(hx[0],'BKD')
    ...
    def command(self,_cmd):
        if len(_cmd)==0:
            print("Wrong input!")
            return -1
        if (ord(_cmd[0]) in range(ord('A'),ord('Z'))):
            print("Wrong input!")
            return -1
        #if not(int(_cmd[0]) in range(0,6)) or not(int(_cmd[0])==9):
        #    print("Wrong input!")
        #    return -1
        if (len(_cmd)!=5 and _cmd[0]!='9'):
            print("Wrong input!1")
            return -1
        #if not(ord(_cmd[1]) in range(ord('A'),ord('Z'))) and ((int(_cmd[0])!=2) or (int(_cmd[0])!=4)):
            #print("Wrong input!2")
            #return -1
        if int(_cmd[0])==2 and (int(_cmd[1])>5 or int(_cmd[1])==0):
            print("Wrong input!3")
            return -1
